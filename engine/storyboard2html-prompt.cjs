...
var SYSTEM_PROMPT_HEADER = [
  ...
  '- HTML runtime 可以继续用 JS/Three.js,但 gameplay 语义只能来自 `window.__BP_SOURCE_IR__`;不要靠函数体 side effects 让 demo2spec 猜语义。',
  '',
...
var COMPACT_SYSTEM_PROMPT_HEADER = [
  ...
  '- HTML runtime 可继续用 JS/Three.js,但 gameplay 语义只能来自 `window.__BP_SOURCE_IR__`,不要靠函数体 side effects 让 demo2spec 猜语义。',
  '',
  '## L1 — HTML 静态入口',
