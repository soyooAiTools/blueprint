...
var SYSTEM_PROMPT_HEADER = [
  ...
  '- value 必含三字段:',
  '  - `license`:字符串。允许值 `"CC0"` / `"CC-BY-4.0"` / `"CC-BY-SA-4.0"` / `"CC-NC-*"`(任一 NC 变体)/ `"proprietary"` / `"unknown"`。',
  '  - `attribution`:作者 / 项目名 / 主页 URL 字符串;若 license 不要求署名(CC0)或 license=unknown 且无来源,写 `null`。',
  '  - `sourceUrl`:外部下载页 URL 字符串;若资产是本地相对路径 / data-uri / 程序化生成,写 `null`。',
