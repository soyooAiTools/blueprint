...
var tmp = fs.mkdtempSync(path.join(os.tmpdir(), 'unitycomponent-v1-cold-corpus-'));
...
assert.ok(corpus.length >= 10, 'cold export corpus must cover at least 10 fixtures before prompt cutover');

console.log('unitycomponent v1 cold export corpus tests passed');
