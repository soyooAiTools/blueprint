...
function usage() {
  console.error('Usage: node scripts/storyboard2html-hardgate.cjs --snapshot <snapshot-schema.json> --report <verify_report.json> [--html <generated.html>] [--expected-phases N]');
  process.exit(2);
}

function parseArgs(argv) {
  var opts = { snapshotSchemaPath: null, verifyReportPath: null, htmlPath: null, expectedPhaseCount: null };
