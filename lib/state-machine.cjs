...
var TASK_TRANSITIONS = {
  ...
  processing:     ['developing', 'building', 'preview_ready', 'completed', 'failed', 'fix_needed', 'done', 'cua_passed', 'cancelled'],
  developing:     ['building', 'failed', 'fix_needed', 'cancelled'],
  building:       ['preview_ready', 'completed', 'failed', 'fix_needed', 'done', 'cua_passed', 'cancelled'],
  preview_ready:  ['processing', 'building', 'failed', 'done', 'cua_passed', 'completed', 'cancelled'],
