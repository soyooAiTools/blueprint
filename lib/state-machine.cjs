...
var TASK_TRANSITIONS = {
  ...
  processing:     ['developing', 'building', 'completed', 'failed', 'fix_needed', 'done', 'cua_passed', 'cancelled'],
  developing:     ['building', 'failed', 'fix_needed', 'cancelled'],
  building:       ['completed', 'failed', 'fix_needed', 'done', 'cua_passed', 'cancelled'],
...
var PROJECT_TRANSITIONS = {
  ...
  spec_extracting:  ['submitted', 'editing', 'cancelled'],           // 提取失败可回退
  submitted:        ['assigned', 'processing', 'developing', 'building', 'reviewing', 'failed', 'done', 'cua_passed', 'feedback', 'cancelled'],
  assigned:         ['processing', 'pending', 'failed', 'cancelled'],
  processing:       ['developing', 'building', 'reviewing', 'failed', 'done', 'cua_passed', 'cancelled'],
  developing:       ['building', 'reviewing', 'failed', 'cancelled'],
  building:         ['reviewing', 'failed', 'done', 'cua_passed', 'cancelled'],
  reviewing:        ['feedback', 'approved', 'failed', 'cancelled'],
  feedback:         ['submitted', 'editing', 'cancelled'],           // 反馈后可重新提交
  approved:         ['committed', 'cancelled'],
  committed:        [],                                 // 终态
  failed:           ['editing', 'submitted', 'cancelled'],           // 允许重试或取消
