...
var PROFILES = {
  ...
  'unitycomponent-v1': {
    ...
    cutoverGate: {
      ...
      acceptedArtifactCorpusMin: 5,
      acceptedArtifactCoreArtifacts: [
        'source-ir.json',
        'playable-scene-ir.json',
        'asset-manifest.json',
        'unity-asset-plan.json or blueprint-unity-asset-plan.json'
      ],
      sourceEvidenceMetadataPolicy: 'optional-pair-validated',
      requiresDeliverySpecSourceParity: true,
      requiresUnityOutputSpecConsistency: true,
      requiresUnityComponentHardgate: true,
      requiresUnityImportCompileSmoke: true,
      requiresUnitySmokeMode: 'required',
      requiresLicenseEnabledUnityCiRunner: true
    }
  }
};
