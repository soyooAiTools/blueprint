...
function buildMarkdown(info) {
  ...
  var commonsNode = isV14Delivery
    ? 'Core/Common/GMP_*.cs<br/>SceneObjectRegistry / ResourceIds / Activator'
  ...
  var runtimeLines = isV14Delivery ? [
    ...
    '    AutoTick --> Systems["GMP_EntityBindingManager / Economy / HUD"]',
    '    PlayerTick --> Systems',
  ...
  if (isV14Delivery) {
    coreRows = [
      ...
      '| `Assets/Scripts/Core/Common` | SceneObjectRegistry、ResourceIds、ScriptActivator 等通用工具 |',
