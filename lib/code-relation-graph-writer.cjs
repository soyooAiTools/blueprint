...
function buildMarkdown(info) {
  ...
  if (isV14Delivery) {
    coreRows = [
      '| `Assets/Scripts/Core/Base` | MonoSingleton、核心枚举、实体/玩家/NPC 基类 |',
...
function buildHtml(info) {
  ...
  var cards = isV14Delivery ? [
    '<div class="card main"><strong>Core/Base</strong><span>MonoSingleton / Core enums / entity base</span></div>',
