...
function validateSceneCodeHierarchy(root, errors) {
  ...
  var codeNames = [
    'GMP_MainManager', 'GMP_EntityManager', 'GMP_PhaseController', 'GMP_SceneEntityRefs', 'GMP_AutoPlayDriver',
...
function validateProgrammerDelivery(root, summary) {
  ...
  return {
    ...
    summary: {
      ...
      maintainabilityDecorativeComponentCount: maintainability.summary.decorativeComponentCount || 0,
      maintainabilityUnusedComponentFileCount: maintainability.summary.unusedComponentFileCount || 0,
      maintainabilityBaseEntityOverreachCount: maintainability.summary.baseEntityOverreachCount || 0,
      maintainabilitySceneEntityRefsSpawnMethodCount: maintainability.summary.sceneEntityRefsSpawnMethodCount || 0,
      maintainabilitySceneEntityRefsTransientFieldCount: maintainability.summary.sceneEntityRefsTransientFieldCount || 0,
