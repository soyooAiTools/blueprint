...
function usage() {
  console.error('Usage: node index.js <demo.html> <outdir> [--theme name] [--blueprint-smoke] [--verify] [--verify-runner direct|production] [--steps N]');
  process.exit(2);
}

function parseArgs(argv) {
  const opts = { html: null, outDir: null, theme: null, blueprintSmoke: false, verify: false, verifyRunner: null, steps: 30 };
